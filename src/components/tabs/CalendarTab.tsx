    ...
    const renderHeader = () => (
        <header className="flex items-start justify-between mb-8 gap-2">
            ...
            <div className="flex gap-2 shrink-0">
                <button onClick={prevMonth} className="w-11 h-11 bg-gray-50 rounded-2xl text-gray-400 hover:text-gray-900 transition-colors flex items-center justify-center">
                    <ChevronLeft className="w-5 h-5" />
                </button>
                <button onClick={nextMonth} className="w-11 h-11 bg-gray-50 rounded-2xl text-gray-400 hover:text-gray-900 transition-colors flex items-center justify-center">
